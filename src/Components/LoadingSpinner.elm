...
view =
    Html.div
        ...
        , Html.Attributes.class "flex items-center justify-center h-screen"
        ]
        [ svg
            [ Html.Attributes.attribute "aria-hidden" "true"
            , SvgAttr.class "w-8 h-8 text-purple-300 animate-spin dark:text-fuchsia-500 fill-fuchsia-500"
